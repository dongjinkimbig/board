<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    %>
    <%
//     	String idx = (String)session.getAttribute("idx"); 원래 이렇게 idx사용해서 검색하면 속도가 유리하대 (인덱싱)
...
<body>
    ...
    <form action="Info" name="regform" id="regform" method = "post" onsubmit="return sendit()">
        ...
        <p>휴대전화 번호: <input type="text" name="hp" id="hp" value="<%=mem_hp%>"></p>
        <p>email : <input type="text" name="email" id="email" value="<%=mem_email%>"></p>
        <p>성별 : 
        ...
        <p>취미 :<label>등산<input type="checkbox" name="hobby" value="등산" 
        		<%
        ...
        <p>우편번호 : <input type="text" name="zipcode" maxlength="5" id="sample6_postcode" value="<%=mem_zipcode%>">
        ...
        <p><button>수정완료</button> <input type="reset" value="다시 작성"> <button type="button" onclick="location.href='login.jsp'">돌아가기</button></p>
    </form>
